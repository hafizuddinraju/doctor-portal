...
const Login = () => {
  const { UserLogin, googleLogin, githubLogin, user } = useContext(AuthDataContext);
    ...
    <div>
      <div className=" w-full md:w-1/3 mx-auto p-8 space-y-3 rounded-xl my-8 bg-gray-200 text-gray-900">
        ...
        >
          ...
          <button
            type="submit"
            className="block w-full font-semibold p-3 text-center rounded-sm text-gray-900 bg-sky-400"
          >
            Sign in
          </button>
        </form>
